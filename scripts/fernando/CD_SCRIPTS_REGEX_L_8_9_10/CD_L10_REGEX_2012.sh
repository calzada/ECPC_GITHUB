...
# Datos portada
perl -pi -e 's/<\?xml version.*?(CORTES GENERALES)/XXZZ?xml version="1.0" encoding="UTF-8" standalone="no"?YYWWXXZZPYYWWXXZZ!DOCTYPE ecpc_CD SYSTEM "cd.dtd"YYWWXXZZPYYWWXXZZecpc_CDYYWWXXZZPYYWWXXZZheaderYYWWXXZZPYYWWXXZZlegislature begin="20111213" end="20151212"YYWWVIIIXXZZ\/legislatureYYWWXXZZPYYWW$1/g' *.xml
...
# sumario
perl -pi -e 's/(SUMARIO)(.*?)(<P>|<H4>|<LI_Title>)(—*\s*?\p{Lu}\p{Lu}+?[^\p{Ll}]\s*?\p{Lu}\p{Lu}+?[^\p{Ll}]\s*?\p{Lu}\p{Lu}.*?[^\p{Ll}][^\p{Ll}]\s*?\(Núm.*?de exp.*?\))/$1$2XXZZPYYWWXXZZ\/indexitemYYWWXXZZPYYWWXXZZ\/indexYYWWXXZZPYYWWXXZZ\/headerYYWWXXZZPYYWWXXZZPYYWWXXZZbodyYYWWXXZZPYYWWXXZZPYYWWXXZZchair who="Posada Moreno, Jesús"YYWWXXZZPYYWWXXZZPYYWW$3$4$5/g' *.xml
...
perl -pi -e 's/(\(El señor presidente|\(La señora presidenta)(\socupa la Presidencia\.\))/XXZZPYYWWXXZZ\/chairYYWWXXZZPYYWW$1$2XXZZPYYWWXXZZchair who="Posada Moreno, Jesús"YYWWXXZZPYYWW/g' *.xml

# etiqueta chair who de presidente
perl -pi -e 's/(XXZZPYYWWXXZZ\/chairYYWW)(XXZZPYYWW\(El señor presidente|XXZZPYYWW\(La señora presidenta)(\socupa la Presidencia\.\))(XXZZPYYWWXXZZchair who="Posada Moreno, Jesús"YYWWXXZZPYYWW)(.*?)(XXZZ\/speechYYWWXXZZPYYWWXXZZ\/interventionYYWW)/$5$6XXZZPYYWW$1XXZZPYYWW$2$3XXZZPYYWW$4/g' *.xml
