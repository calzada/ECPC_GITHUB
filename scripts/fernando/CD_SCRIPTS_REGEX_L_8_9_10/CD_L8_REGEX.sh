...
# Datos portada
perl -pi -e 's/<\?xml version.*?(CORTES GENERALES)/XXZZ?xml version="1.0" encoding="UTF-8" standalone="no"?YYWWXXZZPYYWWXXZZ!DOCTYPE ecpc_CD SYSTEM "cd.dtd"YYWWXXZZPYYWWXXZZecpc_CDYYWWXXZZPYYWWXXZZheaderYYWWXXZZPYYWWXXZZlegislature begin="20040402" end="20080401"YYWWVIIIXXZZ\/legislatureYYWWXXZZPYYWW$1/g' *.xml
...
# sumario
perl -pi -e 's/(SUMARIO)(.*?)(<P>|<H4>|<LI_Title>)(—*\s*?\p{Lu}\p{Lu}+?[^\p{Ll}]\s*?\p{Lu}\p{Lu}+?[^\p{Ll}]\s*?\p{Lu}\p{Lu}.*?[^\p{Ll}][^\p{Ll}]\s*?\(Núm.*?de exp.*?\))/$1$2XXZZPYYWWXXZZ\/indexitemYYWWXXZZPYYWWXXZZ\/indexYYWWXXZZPYYWWXXZZ\/headerYYWWXXZZPYYWWXXZZPYYWWXXZZbodyYYWWXXZZPYYWWXXZZPYYWWXXZZchair who="Marín González, Manuel"YYWWXXZZPYYWWXXZZPYYWW$3$4$5/g' *.xml
...
# hacer distinción donde empieza una intervención señalando que es un párrafo diferente 1
...
perl -pi -e 's/(<PARRAFO_2>)El señor\s*?(PRESIDENTE):(.*?)(<PARRAFO_2>)/$1XXZZPYYWWXXZZinterventionYYWWXXZZPYYWWXXZZspeakerYYWWXXZZPYYWWXXZZnameYYWWMARÍN GONZÁLEZXXZZ\/nameYYWWXXZZPYYWWXXZZpostYYWW$2XXZZ\/postYYWWXXZZPYYWWXXZZ\/speakerYYWWXXZZPYYWWXXZZspeech language="ES"YYWWXXZZPYYWW$3XXZZPYYWWXXZZ\/speechYYWWXXZZPYYWWXXZZ\/interventionYYWWXXZZPYYWW$4/g' *.xml

# intervenciones PRESIDENTe/a: (del congreso) 2
perl -pi -e 's/(<PARRAFO_2>)La señora\s*?(PRESIDENTA):(.*?)(<PARRAFO_2>)/$1XXZZPYYWWXXZZinterventionYYWWXXZZPYYWWXXZZspeakerYYWWXXZZPYYWWXXZZnameYYWWMARÍN GONZÁLEZXXZZ\/nameYYWWXXZZPYYWWXXZZpostYYWW$2XXZZ\/postYYWWXXZZPYYWWXXZZ\/speakerYYWWXXZZPYYWWXXZZspeech language="ES"YYWWXXZZPYYWW$3XXZZPYYWWXXZZ\/speechYYWWXXZZPYYWWXXZZ\/interventionYYWWXXZZPYYWW$4/g' *.xml
...
perl -pi -e 's/(\(El señor presidente|\(La señora presidenta)(\socupa la Presidencia\.\))/XXZZPYYWWXXZZ\/chairYYWWXXZZPYYWW$1$2XXZZPYYWWXXZZchair who="Marín González, Manuel"YYWWXXZZPYYWW/g' *.xml

# etiqueta chair who de presidente
perl -pi -e 's/(XXZZPYYWWXXZZ\/chairYYWW)(XXZZPYYWW\(El señor presidente|XXZZPYYWW\(La señora presidenta)(\socupa la Presidencia\.\))(XXZZPYYWWXXZZchair who="Marín González, Manuel"YYWWXXZZPYYWW)(.*?)(XXZZ\/speechYYWWXXZZPYYWWXXZZ\/interventionYYWW)/$5$6XXZZPYYWW$1XXZZPYYWW$2$3XXZZPYYWW$4/g' *.xml
...
## EJEMPLOS DE ALGUNOS ONE-LINERS QUE AÑADO Y PARECEN NO FUNCIONAR, LOS IRÉ AÑADIENDO AL ARCHIVO "ECPC PARCHEADO ESPECÍFICO.TXT"
# quitar "Página"
#perl -pi -e 's/\n^Página//g' *.xml
